...
However looking into Strava's API Agreement seems complex, restrictive and made me question, that for something simple that I want do I really need all of that? Garmin was a different story an application had to be sent to them in order to gain acces to their libraries, APIs. This application of mine was rejectet pretty swiftly. After this I just tried to focus on what I want to create.
...
This was my idea that I proudly presented to my mentor. However, after some research and meetings with my mentor made me realise I don't have the techniqual skills, experience or time to create something like the initial idea was, plus to launch an MVP product I don't even need all of that. Considering all these details I narrowed down the scope of the project to aim for an MVP outcome creating a simple user interface much like Strava.
...
Upon opening the page in the browser next to the name of the website the logo is positioned in the left side of the navbar. Dynamic and reflecting the colour scheme of the site

+ Activity types list

![activitytype](/assets/images/activitytype.png)

 The user can choose the type of activity from a scroll down list. The list is not limited to the existing choices, furhter activities can be added.
...
However, I think the idea of the activity tracker and the concept is worth to pursue.
